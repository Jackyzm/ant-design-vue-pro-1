<template>
  <div>
    <a-row :gutter="24">
      ...
      <a-col v-bind="topColResponsiveProps">
        <ChartCard :bordered="false" title="访问量" :contentHeight="46">
          <template slot="action">
            <a-tooltip title="指标说明">
              <a-icon type="info-circle-o" />
            </a-tooltip>
      ...
      <a-col v-bind="topColResponsiveProps">
        <ChartCard :bordered="false" title="支付笔数" :contentHeight="46">
          <template slot="action">
            <a-tooltip title="指标说明">
              <a-icon type="info-circle-o" />
            </a-tooltip>
      ...
      <a-col v-bind="topColResponsiveProps">
        <ChartCard :bordered="false" title="运营活动效果" :contentHeight="46">
          <template slot="action">
            <a-tooltip title="指标说明">
              <a-icon type="info-circle-o" />
            </a-tooltip>
            ...
            <div class="salesExtraWrap">
              <div class="salesExtra">
                <a
                  ...
                  @click="() => this.selectDate('today')"
                  >今日</a
                >
                <a
                  :class="isActive('week')"
                  @click="() => this.selectDate('week')"
                  >本周</a
                >
                <a
                  :class="isActive('month')"
                  @click="() => this.selectDate('month')"
                  >本月</a
                >
                <a
                  :class="isActive('year')"
                  @click="() => this.selectDate('year')"
                  >全年</a
                >
              </div>
              <a-range-picker
